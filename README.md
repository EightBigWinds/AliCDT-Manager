...
比如说香港是 "regionId=cn-hongkong#/" 那么地域ID就填cn-hongkong

比如说日本是 "regionId=ap-northeast-1#/" 那么地域ID就填ap-northeast-1

比如说新加坡是 "regionId=ap-southeast-1#/" 那么地域ID就填ap-southeast-1
